...
function findOrdersWithoutPendingTasks() {
    return __awaiter(this, void 0, void 0, function () {
        var orders, orderNumbers, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    orders = _a.sent();
                    orderNumbers = orders.map(function (order) { return order.shipstation_order_number; })
                        .filter(function (num) { return typeof num === 'string' && num !== ''; });
                    console.log(orderNumbers.join(';'));
                    return [3 /*break*/, 5];
                case 2:
                    error_1 = _a.sent();
                    console.error("Error finding orders:", error_1);
                    return [3 /*break*/, 5];
