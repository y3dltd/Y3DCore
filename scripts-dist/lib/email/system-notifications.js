...
(function (ErrorCategory) {
    ErrorCategory["ORDER_PROCESSING"] = "ORDER_PROCESSING";
    ErrorCategory["AI_SERVICE"] = "AI_SERVICE";
    ErrorCategory["DATABASE"] = "DATABASE";
    ErrorCategory["SHIPSTATION"] = "SHIPSTATION";
 ...
 */
export async function sendSystemNotification(title, message, severity = ErrorSeverity.ERROR, category = ErrorCategory.GENERAL, details, customOptions) {
    try {
...
<table style="border-collapse: collapse; width: 100%;">
  <tr>
    ...
    <td style="padding: 8px; border: 1px solid #ddd; font-weight: bold; color: ${severity === ErrorSeverity.CRITICAL ? '#dc3545' : (severity === ErrorSeverity.ERROR ? '#fd7e14' : '#ffc107')};">${severity}</td>
  </tr>
  <tr>
 ...
 */
function formatErrorDetails(details, includeStack = true) {
    if (!details)
        return '';
