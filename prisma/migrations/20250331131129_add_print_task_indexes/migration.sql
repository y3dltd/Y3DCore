...
-- CreateIndex
CREATE INDEX `PrintOrderTask_needs_review_idx` ON `PrintOrderTask`(`needs_review`);

-- CreateIndex
CREATE INDEX `PrintOrderTask_shorthandProductName_idx` ON `PrintOrderTask`(`shorthandProductName`);
