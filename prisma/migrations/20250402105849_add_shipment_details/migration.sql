...
-- AlterTable
ALTER TABLE `Order` ADD COLUMN `dimensions_height` DECIMAL(10, 2) NULL,
    ADD COLUMN `dimensions_length` DECIMAL(10, 2) NULL,
    ADD COLUMN `dimensions_units` VARCHAR(20) NULL,
    ADD COLUMN `dimensions_width` DECIMAL(10, 2) NULL,
    ADD COLUMN `insurance_insure_shipment` BOOLEAN NULL,
    ADD COLUMN `insurance_insured_value` DECIMAL(10, 2) NULL,
    ADD COLUMN `insurance_provider` VARCHAR(50) NULL,
