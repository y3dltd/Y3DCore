/*
  ...
  - A unique constraint covering the columns `[orderId,sku,product_name]` on the table `PrintOrderTask` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `PrintOrderTask_orderId_sku_product_name_key` ON `PrintOrderTask`(`orderId`, `sku`, `product_name`);
