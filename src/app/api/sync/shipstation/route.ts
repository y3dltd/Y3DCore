...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    try {
        ...
        console.error('Error during ShipStation tag sync (continuing with order sync):', tagSyncError);
    ...
    } catch { // Remove unused variable entirely
  ...
  } catch (error) { // Catch errors from getShipstationOrders or other unexpected issues
